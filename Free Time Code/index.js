...
(function(){
	...
	var questions = {
		...
		time:{
			text:"What time is best?",
			options:[
				{
					text: "Afternoon",
					reply_text: "Afternoon would be best",
					next_question: "confirm"
				},
				{
					text: "Morning",
					reply_text: "Morning would be best",
					next_question: "confirm"
				},
				{
					text: "Stop..",
					reply_text: "Please stop....",
					next_question: "confirm"
				}
			]
		},
		confirm:{
			text:"No problem, we'll arrange to have you killed :)",
			// options:[
			// 	{
			// 		text: "Afternoon",
			// 		reply_text: "Afternoon would be best",
